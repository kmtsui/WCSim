...
G4LogicalVolume* WCSimDetectorConstruction::ConstructMultiPMT(G4String PMTName, G4String CollectionName)
{
  ...
  G4double innerR_curv_container = vessel_radius_curv - mPMT_outer_material_d - 59.62*mm;  //updated number with support structure
  ...
  pmtDistance -= (vessel_radius_curv - mPMT_outer_material_d - 59.62*mm); //updated number with support structure
